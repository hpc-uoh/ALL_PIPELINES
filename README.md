...
| [**MiRScout**](https://github.com/AGENslab/MiRScout) | 0.1.1 | Active | MiRScout is a Nextflow DSL2 pipeline for miRNA candidate discovery using dual trimming strategies, BrumiR-based prediction, core-catalog... | Nextflow, fastp, cutadapt, BrumiR, Random Forest |
...
| [**nf-sarcopipe**](https://github.com/AGENslab/nf-sarcopipe) | 0.1.1 | Active | Sarcopipe is a Nextflow pipeline designed for the identification and linkage of miRNAs and mRNAs, specifically tailored for analyzing Sarcopenia... | Nextflow, fastp, BrumiR, Slurm, miRDeep2 |
| [**nf-sarcopipe_ms**](https://github.com/AGENslab/nf-sarcopipe_ms) | No declared version | Documented | Reproducible analysis scripts, figure generation, and supplementary workflows for the nf-Sarcopipe manuscript. | Not specified |
...
| [**quantmiR**](https://github.com/AGENslab/quantmiR) | No declared version | Active | Quantifies trimmed single-end short-read samples against a miRNA catalog using Salmon, then merges all per-sample quantifications into TPM and... | Nextflow, Slurm |
...
| [**AncestryDMR**](https://github.com/digenoma-lab/AncestryDMR) | 0.0.1 | Active | A Nextflow pipeline to identify ancestry-related DMRs in cohorts sequenced with Oxford Nanopore (ONT). The pipeline supports two analysis modes... | Nextflow, Slurm, Samtools, bcftools, bedtools |
...
| [**covid_genomics**](https://github.com/digenoma-lab/covid_genomics) | v2.0 | Documented | Analysis repository for SARS-CoV-2 genomes from Chile, with emphasis on consensus SNVs, intra-host SNVs (iSNVs), lineage/variant comparisons, and... | Python, R |
...
| [**data-TARA**](https://github.com/digenoma-lab/data-TARA) | No declared version | Documented | Ubicación en el cluster | RStudio |
...
| [**histo-rna-integration**](https://github.com/digenoma-lab/histo-rna-integration) | No declared version | Documented | Vertical integration of WSI + mRNA in TCGA-COAD (colon adenocarcinoma) using MOFA2. | Nextflow, Python, STAR, DESeq2 |
| [**HistologyEvaluateMIL**](https://github.com/digenoma-lab/HistologyEvaluateMIL) | 0.0.1 | Experimental | Nextflow pipeline to evaluate Multi-Instance Learning (MIL) approaches on digital histology slides, using immunohistochemistry (IHC) as ground truth. | Nextflow, Python, Slurm, Transformer |
...
| [**HistologyPyramidConvert**](https://github.com/digenoma-lab/HistologyPyramidConvert) | 0.0.1 | Active | A Nextflow pipeline that converts standard histology TIFF whole-slide images (WSI) into tiled pyramid TIFFs (OME-style pyramid TIFF), suitable for... | Nextflow, Slurm |
...
| [**LEMUR**](https://github.com/digenoma-lab/LEMUR) | v1.4 | Documented | Stream-merge modkit bedMethyl files from phased haplotypes into a single TSV matrix, with optional local beta-binomial imputation. Built for... | Slurm |
...
| [**MANTIS**](https://github.com/digenoma-lab/MANTIS) | v1.0 | Documented | Python tools to align H&E and IHC whole-slide images (WSIs) via comparable thumbnails, tissue masks, and 2D mask cross-correlation. A second CLI... | Python, OpenCV |
