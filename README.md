...
| [**HistoAlign**](https://github.com/digenoma-lab/HistoAlign) | 0.1.0 | Documented | Python tools to align H&E and IHC whole-slide images (WSIs) via comparable thumbnails, tissue masks, and 2D mask cross-correlation. | Python, OpenCV |
