...
| [**MiRScout**](https://github.com/AGENslab/MiRScout) | 0.1.1 | Active | MiRScout is a Nextflow DSL2 pipeline for miRNA candidate discovery using dual trimming strategies, BrumiR-based prediction, and read-level... | Nextflow, fastp, cutadapt, BrumiR, Random Forest |
...
| [**Haplotag**](https://github.com/digenoma-lab/Haplotag) | 0.0.1 | Active | A Nextflow pipeline to haplotag Oxford Nanopore long reads and compute phased methylation pileups (5mC / 5hmC at CpG sites). | Nextflow, Slurm, Samtools, bcftools, Nanopore |
...
| [**HistologyEvaluateMIL**](https://github.com/digenoma-lab/HistologyEvaluateMIL) | 0.0.1 | Experimental | Nextflow pipeline to evaluate Multi Instance Learning approaches using IHC slides as ground truth. | Nextflow, Slurm |
...
| [**HistoMatch**](https://github.com/digenoma-lab/HistoMatch) | 0.1.0 | Documented | Python tools to align H&E and IHC whole-slide images (WSIs) via comparable thumbnails, tissue masks, and 2D mask cross-correlation. A second CLI... | Python, OpenCV |
...
| [**MergeBedMethyl**](https://github.com/digenoma-lab/MergeBedMethyl) | v1.1 | Documented | Stream-merge modkit bedMethyl files from phased haplotypes into a single TSV matrix. Built for cohorts where each sample has _hp1.bedmethyl and... | Slurm |
