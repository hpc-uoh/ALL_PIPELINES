...
| [**LEMUR**](https://github.com/digenoma-lab/LEMUR) | v1.3 | Documented | Stream-merge modkit bedMethyl files from phased haplotypes into a single TSV matrix, with optional local beta-binomial imputation. Built for... | Slurm |
