...
| [**MergeBedMethyl**](https://github.com/digenoma-lab/MergeBedMethyl) | v1.0 | Documented | Stream-merge modkit bedMethyl files from phased haplotypes into a single TSV matrix. Built for cohorts where each sample has _hp1.bedmethyl and... | Slurm |
